...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM $type WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($type_err)){
        ...
        $sql = "INSERT INTO $type (username, password) VALUES (?, ?)";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($type_err)) ? 'has-error' : ''; ?>">
                ...
                <select name="type" id="type">
					<option value="nochoice">[Choose account type]</option>
